...
class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            switch (rowType) {
                case TYPE_ITEM:
                    convertView = mInflater.inflate(R.layout.todo_line, null);
                    ...
                    break;
                case TYPE_SEPARATOR:
                    convertView = mInflater.inflate(R.layout.project_name, null);
                    holder.textView = (TextView) convertView.findViewById(R.id.project);
